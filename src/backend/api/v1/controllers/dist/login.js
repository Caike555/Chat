...
exports.login_post = exports.login_get = void 0;
var logging_1 = require("../../../config/logging");
var login_1 = require("../handlers/login/login");
var Page = 'login';
var NAMESPACE = Page + " Controller";
var login_get = function (req, res, next) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, login_1["default"](req)];
            case 1:
                returnData = _a.sent();
